...
@section('modulecontent')
    ...
    <div class="portlet-box">
        <div class="portlet-header flex-row flex d-flex align-items-center">
            <a href="/solaris/add/galleries" class="btn btn-rounded btn-primary btn-sm m-r-5">Formu
                Sıfırla</a>
            <a href="/solaris/{{request("module")}}" class="btn btn-rounded btn-danger btn-sm">Tüm İçerikler</a>
        </div>


        <form class="form-horizontal dropzone" method="POST" action="/solaris/addgalleries" id="formData"
            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="title">Galeri Kategorisi</label>
