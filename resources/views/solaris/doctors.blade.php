            ...
            <table class="table table-striped mb-0 table-sm">
                ...
                @foreach($cData->data as $key=>$val)
                    ...
                    <tr id="dat-{{$val->id}}">
                        ...
                        <td>
                            <a href="/solaris/doctors/edit/{{$val->id}}"  class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                            <a style="float: right;" onclick="sil('{{Crypt::encryptString(json_encode(array("sID"=>$val->id,"func"=>"doctor","method"=>"destroy")))}}',{{$val->id}})" class="btn btn-danger btn-sm"><i class="fas fa-times"></i></a>
                        </td>
                    </tr>
                @endforeach
